...
function Home() {
  ...
  return (
    ...
    <HelmetProvider>
     ...
     <section style={{backgroundPositionY:"6.75rem"}} className="section-home_header w-full background-primary xl:px-0 px-4 xl:bg-[url('../src/assets/img/bg-header_home.svg')] bg-cover bg-no-repeat lg:bg-center 2xl:bg-top">
