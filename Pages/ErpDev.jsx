...
function ErpDev() {
  ...
  return (
    <>
      ...
      <section className="section-cta-erp w-full xl:px-0 px-4">
        <div className="xl:container mx-auto">
          <div className="cta-erp-content_wrapper flex flex-col lg:gap-[3.125rem] gap-[1.25rem] lg:p-[8.813rem_5.938rem_11.313rem] p-[1.25rem]">
            <div className="cta-erp-start_content flex lg:flex-row flex-col justify-between gap-[1.25rem]">
              <div className="flex flex-col lg:gap-[8.813rem] gap-[1.25rem] w-full lg:max-w-[29rem]">
                <h3 className='md:text-[2.5rem] text-[1.5rem] text-black'>What is ERP Software Development?</h3>
                <div className="block lg:ms-[2.125rem]"><Button btn="btn1" to="/get-in-touch" className='btn-primary-smc'>Get In Touch</Button></div>
              </div>
              <CardCover bg="bg-[#fff] w-full lg:max-w-[31.188rem]" selectCard="cc4">
                <div className="flex flex-col gap-[2rem] sm:text-[1.25rem] text-[1rem] font-normal text-black">
                  <p>Enterprise Resource Planning (ERP) software development involves creating comprehensive business management solutions that integrate and streamline various processes within an organization. ERP systems are designed to enhance efficiency, facilitate data flow, and provide real-time information across different departments.</p>
                  <p>The goal is to offer a tailored solution that improves your business processes, supports growth, and adapts to evolving needs.</p>
                </div>
              </CardCover>
            </div>
            <div className="cta-erp-mid_content flex flex-col gap-[1.25rem] lg:mt-[3.438rem]">
              <div className="flex lg:flex-row flex-col gap-[1.25rem]">
              <p className="font-semibold text-[1.25rem] text-[#00000040]">Benefit</p>
              <h3 className="text-black md:text-[2.5rem] text-[1.5rem] text-center mx-auto">Custom <br /> ERP Development</h3>
              </div>
              <p className='text-[1rem] text-black text-center'>Custom ERP development has a number of important advantages that can be tailored to your business needs. These solutions are built specifically to match the unique processes and requirements of your business.</p>
            </div>
            <div className="cta-erp-end_content">
              .....
            </div>
          </div>
        </div>
