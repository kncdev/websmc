...
function OurCapabilities() {
  ...
  return (
    <>
      ...
      <section style={{backgroundPositionY:"6.75rem"}} className="section-our-cap_header relative w-full background-primary xl:bg-[url('../src/assets/img/bg-our-capabilities.svg')] bg-cover bg-no-repeat">
